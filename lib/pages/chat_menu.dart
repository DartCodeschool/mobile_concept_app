            ...
            children: [
              Container(
                ...
                child: const Row(
                  children: [
                    Text(
                      'Ja mega gut. Danke dir.',
                      style: TextStyle(fontSize: 14.4, fontWeight: FontWeight.w400, color: Color(0xFF36383D)),
                    ),
                    Icon(Icons.done_all),
                  ],
                ),
        ...
        children: [
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: Colors.black12, spreadRadius: 5, blurRadius: 4, offset: Offset(0, 3)),
              ],
            ),
            child: const Padding(
